      ...
      <main className="pt-32 pb-24 px-6 min-h-[80vh] flex items-center">
        <div className="container mx-auto max-w-6xl">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <p className="text-xs tracking-widest uppercase text-white/30 mb-6">Research</p>
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group aspect-[8.5/11] w-full max-w-md mx-auto bg-white relative overflow-hidden hover:shadow-[0_0_60px_-15px_rgba(255,255,255,0.15)] transition-shadow"
            >
              <div className="absolute inset-10 flex flex-col justify-between">
                <div>
                  <h3 className="font-heading font-black text-3xl text-black leading-tight tracking-tight mb-3 pt-6">THE NEW FRONT</h3>
                  <div className="w-12 h-0.5 bg-black"></div>
                </div>
                <p className="text-black/30 text-[10px] tracking-[0.2em] font-bold uppercase">Research Report</p>
              </div>
